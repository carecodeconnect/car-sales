...
To interact with the report, select items from the "Tables of contents".

Some of the charts are interactive. To play with the data visualisations, hover your curser over the data.

To display code chunks, click on "Show the code".
...
print(f"🚗 Car make and color combination: {most_popular_combination['make']} in colour {most_popular_combination['exterior_color']} (count: {most_popular_combination['count']})")
print()
...
print(f"🚘 Car make: {most_popular_make['make']} (count: {most_popular_make['count']})")
print()
...
print(f"🎨 Colour: {most_popular_color['exterior_color']} (count: {most_popular_color['count']})")
```
...
# Display the results
print(f"The total sales in Bath is £{bath_sales[0]}.")
print()
print(f"The average sales in other cities is £{average_sales_other_cities:.2f}")
print()
print(f"The difference is £{difference[0]:.2f}")
```
...
`carecodeconnect@pm.me`

[Click here to view the code](https://github.com/carecodeconnect/car-sales)